...
public interface ChangesResource
{
     ...
     * @param type the types to keep, comma separated, {@code change} for the changes the version brings and
     *            {@code migration} for its backward compatibility and migration notes, or {@code null} to keep both
    ...
    ChangesRepresentation getChanges(@PathParam("wikiName") String wikiName, @PathParam("product") String product,
        ...
        @QueryParam("type") String type, @QueryParam("released") String released,
