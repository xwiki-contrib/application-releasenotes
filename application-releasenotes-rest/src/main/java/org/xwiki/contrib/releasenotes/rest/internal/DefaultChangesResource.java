    ...
    implements ChangesResource, XWikiRestComponent
{
    ...
    public ChangesRepresentation getChanges(String wikiName, String product, String version, String audience,
        String category, String importance, String containsScreenshots, String type, String released,
        boolean aggregated, String limit, String offset) throws ReleaseNotesException
    {
        return inWiki(wikiName, () -> {
            ...
            parameters.put(ChangeQueryParser.TYPES, type);
