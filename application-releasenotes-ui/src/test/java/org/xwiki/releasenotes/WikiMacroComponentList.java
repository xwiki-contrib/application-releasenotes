...
/**
 * The components needed by a page test to register and execute the wiki macros of this application. XWiki provides
 * the same list as {@code org.xwiki.rendering.wikimacro.internal.WikiMacroFactoryComponentClass}, but only since
 * XWiki 15.2 while this application supports XWiki 14.10.
 *
 * @version $Id$
 */
@Documented
...
@ComponentList({
    ...
    org.xwiki.component.wiki.internal.bridge.DefaultContentParser.class,
    org.xwiki.rendering.internal.parser.DefaultContentParser.class,
    DefaultWikiMacroRenderer.class
})
@Inherited
public @interface WikiMacroComponentList
{
}
